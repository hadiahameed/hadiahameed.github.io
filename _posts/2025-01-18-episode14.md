...
## <span style="color:blue">What was Navan's product strategy?</span> [9]   
   ...
   + Workflow Insights:
      + Uncertainty in the agent's response is caused by the gap between the **Information Needed** by and **Information Given** to the agent. Navan's challenge: Less visibility in travel expenses, complex travel policies. 
...
<div class="embed-container">
  <iframe
      src="https://youtu.be/kBVrPS4_u5k"
      width="700"
      height="480"
      frameborder="0"
      allowfullscreen="">
