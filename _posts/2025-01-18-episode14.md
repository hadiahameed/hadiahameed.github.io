...
## <span style="color:blue">What was Navan's product strategy?</span> [9]   
   ...
   + Orchestration:
      ...
      + Dealing with the clashes between agents' responses.
   + Guardrails:
      ...
      Navan's approach was to limit the $ amount that the agent can approve for expense reimbursements. providing summary of the reasoning used behind every response, escalate unusual decisions taken by the agent to an actual human.
