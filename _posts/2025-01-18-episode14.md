...
My blog posts will be divided into two sections:  
 1. The Bootcamp: What I learned from the bootcamp during the week.  
 2. The Basics: What I had to learn on my own to understand #1.  
...
Traditionally, control logic in systems was designed using fixed instructions, making the code follow a predictable and deterministic flow. But in an agentic flow, multiple LLM agents can be used to perform specialized tasks using special tools, different data sources and a history of past interactions with the end user, thereby becoming increasingly specialized in their tasks and gaining domain knowledge with each iteration. So, in summary, an agent has three properties:  
...
<figure>
  ...
  <figcaption>Example of a code using LangChain. Source [4]</figcaption>
</figure>   
...
[5] [LLM Products vs Traditional Digital Products by Amin Bashi](https://www.youtube.com/watch?v=d-6hORxdGK0&list=PLncP69UJsovhWJYC7tH3EfHim8UNrrsBp&index=2)   
...
[9] [Building Agentic Products by Amin Bashi](https://maven.com/p/cd139b)
