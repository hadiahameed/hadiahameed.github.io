...
+ <span style="color:blue">Step 2(a): If we know the population variance for the salary of each department, calculate the confidence interval for the mean salary of a police officer and a social worker in New York for the year 2020. 
...
+ <span style="color:blue">Step 2(a): We are interested in knowing the salary increase for each department from 2020 to 2021. Calculate the confidence interval for that increase with 95% confidence.</span>
...
<figure>
  ...
  <figcaption>Case 3: Confidence interval for difference of two means, dependent samples</a></figcaption>
</figure> 
