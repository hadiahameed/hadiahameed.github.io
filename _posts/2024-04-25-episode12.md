...
<figure>
  ...
  <figcaption>Case 4 (a): Checking if there is a significant mean difference between two dependent samples.</a></figcaption>
</figure> 

<p style="color:red"> A p-value is a probability that the results from the sample dataset are occurred by chance. Low p-values are considered good. We reject the null hypothesis that the mean difference between police salaries for 2020 and 2021 is 0 because | t stat | = 68 which is greater than t-critical value of 1.96. This is a two-tailed test becuase the null hypothesis was that the salary difference between 2020 and 2021 is 0 and alternative hypothesis is that the salary difference between 2020 and 2021 is not 0. 

To prove Hari Singh wrong we compare the absolute t stat with one tailed t critical value, and that too shows that we can reject the null hypothesis and that the salary did increase from 2020 to 2021 with 95% confidence.</p>
