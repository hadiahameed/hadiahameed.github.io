...
During my work as a data analyst, I generally enjoy presenting new data visualizations to stakeholders across diverse departments and love walking them through complicated dashboards and wacthing them have an Aha! moment. However, sometimes I have struggled to push back on certain KPI requests from non-data folks, which I find rather redundant.    
