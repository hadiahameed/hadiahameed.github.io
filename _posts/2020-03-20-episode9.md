...
This is the inductive bias introduced by William of Occam in 1320. It says, "Prefer the simplest hypotheses that fits the data." It is also called "law of parsimonyIt is kind of a mental model that encourages to look for the simplest solution to a problem that works for given set of circumstances rather than over-complicated solutions.  
